...
// Coverflow Carousel — sourced from Ruixen UI's public registry
// (https://ruixen.com/r/coverflow-carousel.json), MIT licensed.
// A rack of square covers with the perspective reversed: the centre card sits
// square to the viewer while its neighbours swing their outer edges forward.
// Drag, throw, snap and infinite looping are hand-rolled — no carousel library.
