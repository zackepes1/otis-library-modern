...
export const metadata: Metadata = {
  title: "Jim Lafayette Memorial Series | Otis Library",
  description: "The Jim Lafayette Memorial Series at Otis Library — programs honoring Jim Lafayette's legacy and commitment to the Norwich community.",
};

export default async function JimLafayettePage() {
  ...
  try {
    ...
    upcoming = all.filter(
      (e) => e.date >= todayStr && e.title.toLowerCase().includes("jim lafayette"),
    );
  } catch {
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 sm:py-16">
      ...
      <h1 className="mt-2 text-3xl font-semibold text-white">Jim Lafayette Memorial Series</h1>
      <p className="mt-3 text-slate-400">
        Programs honoring Jim Lafayette's legacy and his commitment to the Norwich community.
      </p>
