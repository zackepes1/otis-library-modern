...
export const metadata: Metadata = {
  title: "Passport to Connecticut Libraries | Otis Library",
  description: "Passport to Connecticut Libraries events at Otis Library — explore participating libraries across the state.",
};

export default async function PassportCTLibrariesPage() {
  ...
  try {
    ...
    upcoming = all.filter(
      (e) => e.date >= todayStr && e.title.toLowerCase().includes("passport"),
    );
  } catch {
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 sm:py-16">
      ...
      <h1 className="mt-2 text-3xl font-semibold text-white">Passport to Connecticut Libraries</h1>
      <p className="mt-3 text-slate-400">
        Visit participating libraries across Connecticut — collect stamps and discover what each has to offer.
      </p>
