...
export const metadata: Metadata = {
  title: "Evening with an Author | Otis Library",
  description: "Upcoming Evening with an Author events at Otis Library — intimate conversations with writers from the region and beyond.",
};

export default async function EveningWithAnAuthorPage() {
  ...
  try {
    ...
    upcoming = all.filter(
      (e) => e.date >= todayStr && e.title.toLowerCase().includes("evening with an author"),
    );
  } catch {
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 sm:py-16">
      ...
      <h1 className="mt-2 text-3xl font-semibold text-white">Evening with an Author</h1>
      <p className="mt-3 text-slate-400">
        Intimate conversations with writers from the region and beyond — free and open to the public.
      </p>
